    ...
    <HeaderContainer>
      ...
      <Navigation isOpen={menuOpen}>
        ...
        <NavItem>
          ...
          >
            PRACTICE AREAS
            <MobileDropdownToggle isOpen={servicesOpen}>▼</MobileDropdownToggle>
          </StyledLink>

          {servicesOpen && (
            <DropdownMenu>
              <StyledDropdownLink to='/california-at-fault-accidents'>
                CALIFORNIA AT FAULT ACCIDENT REPORTING
              </StyledDropdownLink>
              <StyledDropdownLink to='/car-accidents'>
                CAR ACCIDENTS
              </StyledDropdownLink>
              <StyledDropdownLink to='/accident-lawyer'>
                ACCIDENT LAWYER
              </StyledDropdownLink>
              <StyledDropdownLink to='/rental-car-accident'>
                RENTAL CAR ACCIDENT
              </StyledDropdownLink>
              <StyledDropdownLink to='/pedestrial-accident'>
                PEDESTRIAN ACCIDENT
              </StyledDropdownLink>
              <StyledDropdownLink to='/airbnb-attorney'>
                AIRBNB ATTORNEY
              </StyledDropdownLink>
              <StyledDropdownLink to='/uber-accident-lawyers'>
                UBER ACCIDENT LAWYERS
              </StyledDropdownLink>
              <StyledDropdownLink to='/wrongful-death-attorney'>
                WRONGFUL DEATH ATTORNEY
              </StyledDropdownLink>
              <StyledDropdownLink to='/electric-scooter-accident'>
