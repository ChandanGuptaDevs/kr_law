...
export const metadata = {
  title: "Electric Scooter Accident Attorney | KR Law Group",
  description:
    "Experienced electric scooter accident attorneys at KR Law Group helping victims get the compensation they deserve for their injuries.",
  keywords:
    "electric scooter accident, e-scooter accident lawyer, scooter injury lawyer, KR Law Group, personal injury",
};
...
export default function ElectricScooterAccidentPage() {
  return (
    <main>
      <SchemaOrg
        title="Electric Scooter Accident Attorney | KR Law Group"
        description="Experienced electric scooter accident attorneys at KR Law Group helping victims get the compensation they deserve for their injuries."
