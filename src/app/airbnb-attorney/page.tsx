...
export const metadata = {
  title: "Airbnb Attorneys | KR Law, APC",
  description:
    "Experienced Airbnb attorneys at KR Law, APC can help you navigate legal issues with short-term rentals. Get expert legal representation for your Airbnb-related matters.",
  keywords:
    "Airbnb attorney, Airbnb lawyer, short-term rental lawyer, vacation rental legal issues, KR Law, APC, Airbnb legal help",
};
...
export default function AirbnbAttorneyPage() {
  return (
    <main>
      <SchemaOrg
        title="Airbnb Attorneys | KR Law, APC"
        description="Experienced Airbnb attorneys at KR Law, APC can help you navigate legal issues with short-term rentals. Get expert legal representation for your Airbnb-related matters."
