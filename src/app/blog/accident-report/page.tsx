...
export const metadata = {
  title:
    "How to Get the Accident Report for Your Personal Injury Case | KR Law Group",
  description:
...
export default function AccidentReportBlogPost() {
  return (
    <main>
      <SchemaOrg
        title="How to Get the Accident Report for Your Personal Injury Case | KR Law Group"
